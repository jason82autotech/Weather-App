//var button=document.getElementById("anything");

//button.addEventListener("click", function (){
    //make a request to weather API here
    //https://api.openweathermap.org/data/2.5/forecast?lat={lat}&lon={lon}&appid=07990665a4fcd6b5ff1bda4694aeda80
    //console.log(button)
